"""
Django settings for noah_45290 project.
...
WSGI_APPLICATION = 'noah_45290.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noah_45290 API",
    "DESCRIPTION": "API documentation for noah_45290 App",
    "VERSION": "v1",
}
